...
# Decides whether to spend mana on a combo break while staggered or grabbed,
# scaled by how aggressive the active behavior mode is. Returns true if it broke.
